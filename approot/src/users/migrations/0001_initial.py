    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(blank=True, default='default.png', null=True, upload_to='avatars')),
                ('status', models.CharField(blank=True, default='All is good!', max_length=255, null=True)),
